      ...
      <div class="container">
        <div class="d-flex">
          ...
          <div class="d-flex order-lg-2 ml-auto">
            ...
            */
            ?>
            <?= $theme->cart(array_merge($cartOptions, ['items' => $cart]));?>
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                ...
                <?php endif;?>
                <?= $theme->accountMenu(['items' => $accountMenu]);?>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row align-items-center flex-row-reverse">    
        <div class="col-auto ml-lg-auto">
          <div class="row align-items-center">
            <div class="col-auto">
              <?= $theme->footerMenu(['items' => $footerMenu]);?>
            </div>
          </div>
        </div>
